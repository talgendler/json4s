...
//  private[this] val descriptors = new Memo[DefaultScalaType, ObjectDescriptor]
  ...
  def scalaTypeOf[T](implicit mf: ScalaType[T]): ScalaType[T] = mf
...
//  private[this] val stringTypes = new Memo[String, Option[ScalaType[_]]]
//  def scalaTypeOf(name: String): Option[ScalaType[_]] =
